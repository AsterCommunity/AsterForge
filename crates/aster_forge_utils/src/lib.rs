...
//! checked numeric conversions, path rendering helpers, loopback host detection, UUID/token
//! helpers, and RAII cleanup guards. The shared error type is intentionally simple so callers can
//! map it into richer product errors.
