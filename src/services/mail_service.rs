...
pub async fn send_test_email(
    ...
    send_rendered(
        ...
        RenderedMail {
            subject: "AsterForge SMTP test".to_string(),
            text_body: format!(
                "This is a test email from AsterForge.\n\nTriggered by: {triggered_by}\nSent at (UTC): {timestamp}\nPublic site URL: {site_url}\n\nIf you received this email, your SMTP settings are working."
            ),
            html_body: format!(
                "<p>This is a test email from AsterForge.</p><p><strong>Triggered by:</strong> {triggered_by}<br /><strong>Sent at (UTC):</strong> {timestamp}<br /><strong>Public site URL:</strong> {site_url}</p><p>If you received this email, your SMTP settings are working.</p>"
            ),
        },
    )
    .await
