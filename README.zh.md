...
| 存储与领域无关辅助 | [`aster_forge_cloud_files_core`](https://forge.astercosm.com/crates/aster_forge_cloud_files_core)、[`aster_forge_storage_core`](https://forge.astercosm.com/crates/aster_forge_storage_core)、[`aster_forge_file_classification`](https://forge.astercosm.com/crates/aster_forge_file_classification) |
